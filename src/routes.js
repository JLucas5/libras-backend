...
routes.post(
	'/alternative/add/:activity_id',
	upload.single('thumbnail'),
	ActivityController.addAlternative
)
routes.get(
	'/alternative/find/:activity_id',
	ActivityController.findAlternatives
)
routes.delete(
	'/alternative/delete/:alternative_id',
	ActivityController.deleteAlternative
)
routes.post(
	'/alternative/edit/:alternative_id',
	upload.single('thumbnail'),
	ActivityController.updateAlternative
)
...
routes.post(
	'/dictionary/new',
	upload.single('thumbnail'),
	DictionaryController.store
)
routes.get('/dictionary/:id', DictionaryController.find)
routes.post(
	'/dictionary/edit/:id',
	upload.single('thumbnail'),
	DictionaryController.edit
)
